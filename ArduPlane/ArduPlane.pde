...
#ifndef THISFIRMWARE
#  define THISFIRMWARE "ArduPlane V2.74beta MPNG-R4 (with Thermal Hunting Modd)"
#endif
/*
...
static int8_t max_selectable_f_modes = 10;
#else
...
{
    if(control_mode == AUTO || control_mode == THERMAL) {
